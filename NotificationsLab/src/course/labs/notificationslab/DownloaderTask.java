				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
							...
							// setAutoCancel(true).
							Notification.Builder nb = new Notification.Builder(mApplicationContext);
							nb.setContentIntent(pendingIntent);
							nb.setContent(mContentView);
							nb.setSmallIcon(android.R.drawable.stat_sys_warning);
							nb.setAutoCancel(true);
							Notification notification = nb.build();

							NotificationManager nm = (NotificationManager) mApplicationContext
