...
public class ExplicitlyLoadedActivity extends Activity {
	...
	private void enterClicked() {
		...
		// Create a new intent and save the input from the EditText field as an
		// extra
		Intent intent = new Intent(ExplicitlyLoadedActivity.this,
				ActivityLoaderActivity.class);
		intent.putExtra("edit_text_value", input);
