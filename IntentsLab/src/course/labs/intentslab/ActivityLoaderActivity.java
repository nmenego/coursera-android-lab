...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// Start an Activity using that intent and the request code defined
		// above
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK) {
			String editTextValue = data.getStringExtra("edit_text_value");
			mUserTextView.setText(editTextValue);
		} else {
			// do nothing..
		}
